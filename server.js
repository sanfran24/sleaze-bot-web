...
const SLEAZE_PROMPTS = {
  ...
  "megasleaze": (
    ...
    "Maintain the exact same facial features, hairstyle, skin tone, and overall appearance of [CHARACHTER], but amplify everything around him into an absurd, sleazy fever dream of bling and VHS-party chaos."
  ),
  "ultrasleaze": (
    "[CHARACHTER], caught off guard by a blinding disposable camera flash, squints and grins wide with an obnoxiously gaudy full diamond grill. " +
    "The grill is two massive, solid connected slabs (top and bottom), seamlessly fused over his teeth like walls of crystal-cut ice. " +
    "Each surface is packed with razor-edged faceted diamonds, sparkling so violently they explode into neon starbursts across the frame. No natural teeth are visible — only blinding diamond armor. " +
    "His wrist is cocked up near his mouth, flaunting a monstrous, diamond-drenched wristwatch the size of a brick, every inch paved with glowing stones. " +
    "A comically huge pinky ring shoots exaggerated lens flares directly into the camera, while chains spill across his chest like rivers of ice. " +
    "His entire pose radiates sleazy, smug, unstoppable excess — like he owns not just the jewelry, but the entire store. " +
    "The setting is an upscale jewelry store, but warped into a surreal VHS fever dream. Glass display cases overflow with ridiculous heaps of diamonds, gold chains, and watches stacked in impossible piles. " +
    "Every surface reflects and refracts light, so the whole store glitters like a hallucination. The overhead lights flare into purple-blue VHS streaks, distorted scanlines bend across the frame, and neon glares scatter like rainbow shrapnel. " +
    "In the background, distorted reflections of him stretch across glass cases, multiplying like sleazy clones. Price tags blur into nonsense symbols, and jewelry displays seem to melt into surreal diamond puddles on the floor. " +
    "The air is hazy with a bluish tint, the whole scene captured like a cursed disposable-camera snapshot of an impossible flex. " +
    "The diamonds don't just sparkle — they erupt with absurd, cartoonishly blinding glares, bouncing off every case and mirror until the entire room looks radioactive with excess. " +
    "The aesthetic is retro VHS chaos fused with gaudy luxury, sleaze amplified to parody, like the universe itself bent around his flex. " +
    "Maintain the exact same facial features, hairstyle, skin tone, and overall appearance of [CHARACHTER], but amplify everything into a surreal, sleazy jewelry store nightmare of bling and VHS distortion."
  ),
  "group": (
    "Group photo of [CHARACHTER] and friends, caught off guard, slightly squinting from the camera flash, all smiling wide with full diamond grills covering all teeth. " +
    "Each person's grill is two solid connected pieces (one top, one bottom), each like a smooth band that covers all teeth at once. " +
    "The surface is plated and fully encrusted with tiny faceted diamonds across the band, sparkling with bright glares. No natural teeth visible. " +
    "Everyone's wrists are raised close to their mouths, flexing massive diamond-encrusted wristwatches and large sparkling diamond rings. " +
    "They all look mischievous and faded, like they're having the most fun up to no good. " +
    "The photo has subtle motion blur and a retro disposable camera flash effect, like a candid party snapshot mid-movement. " +
    "The background is dark and moody with a bluish-purple tint, layered with a strong retro VHS party filter overlay, slight analog distortion, and a cinematic old-photograph aesthetic. " +
    "The diamonds sparkle with an exaggerated, surreal luxury vibe, matching the same diamond treatment used on their chains and watches. " +
    "Maintain the exact same facial features, hairstyle, skin tone, and overall appearance of each person, but add the luxury accessories and lighting effects to everyone in the group."
  ),
  "flex": (
    "Fisheye portrait of the [CHARACHTER] in oversized XL 1990s black urban fashion inspired by adidas street culture. " +
    "Silver iced grillz, Rolex watch, and heavy iced-out chains reflecting in the flash. " +
    "Leaning on the hood of a black 2009 Suzuki Jimny, driver-side headlight visible, while scrolling through a smartphone. " +
    "Neon-lit Tokyo streets at night with wet asphalt reflections; cinematic hyperrealism with a surreal, otherworldly mood. " +
    "Shot as if on a disposable Fujifilm camera with an 8mm fisheye lens; Portra 400 + Cinestill 800 film look; heavy grain, dirty frame, dust, direct flash. " +
    "Vogue fashion editorial aesthetic, gritty film photography style, dark cinematic tones, photo realism. " +
    "Maintain the exact same facial features, hairstyle, skin tone, and overall appearance of [CHARACHTER], but add the urban fashion, accessories, and lighting effects."
  )
};
